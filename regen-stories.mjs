...
const storyPrompts = {
  ...
  6: {
    ...
    pagePrompts: [
      ...
      `${STYLE_PREFIX} The cake is done! ${CHARS.tina_mom} taking a beautiful golden cake out of the oven. ${CHARS.bubu} sniffing the delicious aroma with eyes closed and a huge smile. Warm golden cake. Warm, delightful kitchen scene.`,
